...
LIBS = $(Logger Pattern PatternFile Patterns Result CluceneIndex)
...
All:
	g++ -c -o lib/Logger.o       lib/Logger.cpp       ${LIBS_INCLUDE} ${CPP_FLAGS}
	g++ -c -o lib/Pattern.o      lib/Pattern.cpp      ${LIBS_INCLUDE} ${CPP_FLAGS}
	g++ -c -o lib/PatternFile.o  lib/PatternFile.cpp  ${LIBS_INCLUDE} ${CPP_FLAGS}
	g++ -c -o lib/Patterns.o     lib/Patterns.cpp     ${LIBS_INCLUDE} ${CPP_FLAGS}
	g++ -c -o lib/Result.o       lib/Result.cpp       ${LIBS_INCLUDE} ${CPP_FLAGS}
	g++ -c -o lib/CluceneIndex.o lib/CluceneIndex.cpp ${LIBS_INCLUDE} ${CPP_FLAGS}

	g++ -o src/logcollectd \
		src/logcollectd.cpp lib/Logger.o lib/Pattern.o lib/Patterns.o \
		lib/PatternFile.o lib/Result.o lib/CluceneIndex.o \
		${LOGCOLLECTD_LIBS} ${LOGCOLLECTD_INCLUDE} ${CPP_FLAGS}
		
	g++ -o src/search src/search.cpp ${SEARCH_LIBS} ${SEARCH_INCLUDE} ${CPP_FLAGS}
